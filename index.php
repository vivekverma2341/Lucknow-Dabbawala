...
<div class="row">
    ...
    <div class=" col-md-4" ><h2 align="center">Sunday Special<span class="badge badge-secondary ml-4">New</span></h2><img src="image/veg3.jpg" class="img-fluid img-thumbnail w-100 h-100"></div>
    <div class=" col-md-4" ><h2 align="center">Non-Veg Tiffin</h2><img src="image/veg2.jpg" class="img-fluid img-thumbnail w-100 h-100"></div>
  </div></div> <br><br><br>
  <!--table price-->
...
<div class="container mt-4" id="contact">
  ...
  <div class="row mb-2">
    ...
    <div class="col-md-8">
      <table class='table'>
        <tr>
          <td>Address : </td><td>12, Vivek Verma ,Jaankipuram, lucknow</td>
        </tr>
        <tr>
          <td>Email : </td><td>vivekmmb2341@dubbawala.com</td>
        </tr>
        <tr>
          <td>Mobile : </td><td>8081508803</td>
        </tr>
      </table>
    </div>
    <div class="col-md-2"></div>
