...
<html>
<head>
   <?php include("bootstrap.php"); ?><style type="text/css">
...
<div class='row'>
    <div class='col-md-12'>
        <span class='display-4 ml-4 mt-4'>Welcome Delivery Boy</span>
...
<div class='row mt-4'>
    ...
    <div class='col-md-3'>
        <ul class="list-group">
  <li class="list-group-item active"><a href="profileserboy.php" class='nav-link text-light'>Profile</a></li>
  <li class="list-group-item"><a href="delivery.php" class='nav-link'>Customer</a></li>
...
if($r=mysqli_fetch_assoc($x)){
    ?>
        <tr><td colspan="2" class='text-center'><img src="<?php echo $r['photo'] ?>"
            style='height: 250px;width:200px' class='img-thumbnail'></td></tr>
    <tr><th>Username</th>
...
$sql2="select * from service_boy where username='$uname'";
$a=mysqli_query($conn,$sql2);
if($b=mysqli_fetch_assoc($a)){
$dbpswd=$b['password'];
if ($dbpswd==$op) {
    
    $sql3="update service_boy set password='$np' where username='$uname'";
